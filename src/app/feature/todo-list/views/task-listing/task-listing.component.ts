...
import {selectTodoListingViewModel, TodoListingViewModel} from "./task-listing.selector";
...
export class TaskListingComponent {
  public vm$: Observable<TodoListingViewModel> = this.store.select(selectTodoListingViewModel);
  constructor(
    private store: Store
  ) {}
